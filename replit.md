...
- July 23, 2025. Integrated Runway AI logo across the application. Added logo to welcome page navigation and hero section, plus small logo in main app header. Logo properly imported from attached assets and displays consistently with brand identity.
