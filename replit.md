...
- July 23, 2025. Created comprehensive Privacy Policy page at /privacy-policy route. Added formal, easy-to-read privacy policy with proper sections covering data collection, usage, security, and user rights. Integrated contact information for Ojas Kandhare (okandy@uw.edu) and Arshia Kathpalia (arshia.x.kathpalia@gmail.com). Page is publicly accessible without authentication and features professional design consistent with Runway AI branding using pink/purple gradients and proper typography.
