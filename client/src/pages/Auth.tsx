        ...
        <div className="flex-grow flex items-center justify-center relative w-full h-full">
          ...
          {authMode === 'landing' && (
            <motion.div
              ...
              className="absolute top-[10%] left-[15%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center space-y-4 w-full max-w-xs px-4 py-4"
            >
              <div className="space-y-4 w-full">
                {whyRunwayAICards.map((card, index) => (
                  <motion.div
                    ...
                    className={`max-w-2xl ${index % 2 === 0 ? 'ml-0 mr-auto' : 'ml-auto mr-0'} bg-white/95 backdrop-blur-sm rounded-3xl p-4 shadow-xl border border-pink-200 hover:shadow-2xl transition-all duration-300`}
                  >
