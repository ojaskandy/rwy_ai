            ...
            <div className="flex flex-col md:flex-row justify-between items-start mb-12">
              <div className="mb-8 md:mb-0">
                ...
                <div className="flex space-x-4 mt-4">
                  <a href="https://www.instagram.com/kickcoacht/" target="_blank" rel="noopener noreferrer" className="transition-colors p-2 hover:bg-red-900/10 rounded-full" style={{ 
                    color: isDarkMode ? 'rgba(156, 163, 175, 0.9)' : 'rgba(107, 114, 128, 0.9)' 
                  }}>
                  ...
                  <a href="https://www.tiktok.com/@kickcoacht" target="_blank" rel="noopener noreferrer" className="transition-colors p-2 hover:bg-red-900/10 rounded-full" style={{ 
                    color: isDarkMode ? 'rgba(156, 163, 175, 0.9)' : 'rgba(107, 114, 128, 0.9)' 
                  }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hover:text-red-500">
                      ...
                      <path d="M15 8v8"></path>
                      <path d="M9 16v2a2 2 0 0 0 2 2h2"></path>
                    </svg>
                  </a>
                </div>
