...
export default function AuthPage() {
  ...
  const handleGoogleSuccess = (credentialResponse: CredentialResponse) => {
    // Normal web flow (this will only be called on web, not native)
  ...
  const handleGoogleLogin = () => {
    window.open("https://www.coacht.xyz/auth", "_blank");
  };

  // Handle native Google login using @codetrix-studio/capacitor-google-auth
  const handleNativeGoogleLogin = async () => {
    try {
      await GoogleAuth.signOut(); // clear old sessions
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black overflow-hidden">
          ...
          >
            ...
            >
              ...
              <div
                className={`h-24 w-24 rounded-full bg-gradient-to-br from-red-700 to-red-600 flex items-center justify-center 
            ...
            <Card className="border-red-900/30 bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-lg shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
              ...
              >
                <TabsList className="grid grid-cols-2 bg-black/50 border-b border-gray-800 rounded-none w-full h-auto p-0">
                  <TabsTrigger
                    value="login"
                    className="data-[state=active]:bg-[#00ff00] data-[state=active]:text-black rounded-none py-3 text-gray-400"
                  >
                    Login
                  </TabsTrigger>
                  <TabsTrigger
                ...
                <TabsContent value="login" className="m-0">
                  ...
                  <CardContent className="flex flex-col items-center space-y-4">
                    {isNative ? (
                      /* Native iOS/Android: Use native Google Auth */
                      <button
                      ...
                      /* Web: Standard Google Login component */
                      <GoogleLogin
                    ...
                    {googleLoginMutation?.isError && (
                      <div className="bg-red-900/30 border border-red-700/50 rounded-lg p-3 w-full">
                        <div className="flex items-center">
                          <span className="material-icons text-red-400 mr-2">
                            error
                          </span>
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  >
                                    ...
                                    <SelectContent className="bg-gray-800 border-gray-700 text-white">
                                      <SelectItem value="less_than_1_year">
                                        Less than 1 year
                                      </SelectItem>
                                      <SelectItem value="1_to_3_years">
                                        1-3 years
                                      </SelectItem>
                                      <SelectItem value="3_to_5_years">
                                        3-5 years
                                      </SelectItem>
                                      <SelectItem value="5_plus_years">
                                        5+ years
                                      </SelectItem>
                                    </SelectContent>
                                  </Select>
            ...
            >
              <div className="p-5 rounded-2xl backdrop-blur-lg border border-red-500/20 bg-gradient-to-br from-gray-900/80 to-black/80 shadow-lg hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-sm text-gray-300">
                  Perfect your Taekwondo stances with AI-powered pose tracking
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl backdrop-blur-lg border border-red-500/20 bg-gradient-to-br from-gray-900/80 to-black/80 shadow-lg hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-sm text-gray-300">
                  Compare your technique with reference performances
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl backdrop-blur-lg border border-red-500/20 bg-gradient-to-br from-gray-900/80 to-black/80 shadow-lg hover:scale-105 transition-transform duration-300">
                ...
                <p className="text-sm text-gray-300">
                  Track improvement with detailed analysis reports
                </p>
              </div>
            </motion.div>
          )}
